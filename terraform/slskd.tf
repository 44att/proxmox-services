...
resource "proxmox_lxc" "slskd" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "pct set ${var.slskd_lxcid} -mp2 /mnt/pve/media_root/aurral,mp=/mnt/media_root/aurral",
      "pct set ${var.slskd_lxcid} -mp3 /mnt/pve/app_config/slskd,mp=/mnt/app_config/slskd",
